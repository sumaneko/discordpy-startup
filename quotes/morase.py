...
def get_morase(bot, m):
	...
	if bot.dying_hp < bot.get_hp():
		quotes = [
			...
			[100 , "そんな恥ずかしいことしませんよ！"],
			[100 , "いやでプー！"],
			[100 , "何度やっても絶対に漏らしませーん、100億回やっても漏らさないようになってるんです～　　・・・って言ったらどうしますか？"],
			[100 , f"{name}さんが先にやってみてくれるならいいですよ！"],
			[100 , "さっきおしっこしたからもう出ませーん"],
			[100 , "しませーん、しませんったらしませーん"],
			[100 , "漏らすわけないでしょ！"],
			[100 , "土下座して頼まれても嫌です～"],
			[60 , f"うるさーーい！{name}さんが漏らしなさいよ！！"],
			[60 , "わ、分かりましたよ・・・すればいいんでしょ？すれば！ちょっと待ってくださいね\n・・・・\nんっ・・・！あああ・・・パンツ履きながらだから　すっっごい気持ち悪いですぅ・・・\n・・・・\nはぁ・・・お掃除と替えのパンツもってこなきゃ"]
			]
	else:
		#瀕死の時
		quotes = [
