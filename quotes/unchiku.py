...
def get_unchiku(bot, m):
	...
	if bot.dying_hp < bot.get_hp():
		...
		quotes = [
			...
			[100 , "ウサギは年中発情期だし子宮が「重複子宮」といって2つあって妊娠してるのに更に妊娠できるんですよ！というか単一子宮な人間とかの方が珍しいみたいですけど"],
			[100 , "キリンの交尾の約90%はオス同士なんですよ！ケンカしてる最中に何故か興奮しておっぱじめるんですって、ウケるー！"],
			[100 , "ヒメフクロネコという有袋類のオスは、交尾に命を懸けすぎて相手探しや本番を終えた後睡眠不足で衰弱死するんですよ"],
			[100 , "有袋類のアンテキヌスは、求愛もせず出会い頭に様々な組み合わせで交尾しまくってその後オスは衰弱して死ぬんですよ"],
			[100 , "タラバガニってカニじゃなくてヤドカリの仲間なんですよ"],
			[100 , "R.I.P.って元々ラテン語のRequiescat In Paceのことで、よくRest In Peaceと言われてるやつは英語にする時に頭文字が同じでそれっぽい意味の単語を入れたものなんですよ"],
			[100 , "謎って漢字の右側って「迷」じゃなくて点が２つついてるんですよ。二点しんにょうっていうらしいんですけど実は他にも結構あるんですよ"],
			[100 , "「HerokuBOTちゃんもRailwayBOTちゃんも死んで、今はGoogleCloudBOTちゃん」なんですって。どういう意味なんですかね？"],
