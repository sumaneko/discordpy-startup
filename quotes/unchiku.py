...
def get_unchiku(bot, m):
	...
	if bot.dying_hp < bot.get_hp():
		...
		quotes = [
			...
			[100, "ダウンジャケットは薄着の方が羽毛に熱が伝わるので暖かいんですよ"],
			[100, "毛布は掛け布団にするより敷布団にして他の布団を掛ける方が暖かいんですよ"],
			[100, "建物でよく見る定礎って中は空洞になっていて、書類などが入っているんですよ。何を入れるか決められてるわけではないけど、\n建設当時の思い出の品とかを入れて壊す時だけ見れるタイムカプセルみたいになってるんですよ"],
